...
export const AuditorProgram: React.FC = () => {
        ...
        <div className="max-w-biggest mx-auto">
          <div className="lg:flex-row flex-col flex justify-between w-full">
            <div className="lg:max-w-2xl lg:mb-[-7%] z-10">
              <h3 className="text-base uppercase font-bold font-montserrat w-full">Track 2 • 6 months</h3>
              <h2 className="text-5xl font-semibold font-montserrat w-full text-brand-500">
                The <i className="font-bold text-black dark:text-white">Auditor</i> Program
              </h2>
              <p className="mt-8 dark:text-white/70 text-black/70">
                The Auditor Program will accept two experienced consultancies that are expanding into ink! security
                audit services.
              </p>
              <p className="mt-6 dark:text-white/70 text-black/70">
                ...
                supporting parachains. The Web3 Foundations Bounty program has allocated a budget for cohorts in the
                Builder Program and Ecosystem Grant recipients to pay for security audits, which must be used to hire
                cohorts in the Auditor Program.
              </p>
              <BigCTA
                className="bg-light-background dark:bg-dark-background mt-16"
                title="Interested?"
                emphasized="Apply"
                cta="to the Auditor Program"
