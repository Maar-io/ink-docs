...
import { BuilderProgramPhases } from './BuildProgramPhases'
import { ScrollPlayer } from '../../../components/ScrollPlayer'

export const BuilderProgram: React.FC = () => {
  return (
    <section>
      <div className="px-4">
        <div className="max-w-biggest mx-auto">
          ...
          <div className="md:flex-row flex flex-col justify-between w-full">
            <div className="md:max-w-2xl w-full">
              <h3 className="text-base uppercase font-bold font-montserrat w-full">Track 1 • 6 months</h3>
              <h2 className="text-5xl font-semibold font-montserrat w-full text-brand-500">
                The <i className="font-bold text-black dark:text-white">Builder</i> Program
              </h2>
              <p className="mt-8 dark:text-white/70 text-black/70">
                The Builder Program is the highest tier for builders. We will only accept two projects that are aspiring
                to build on ink!. If accepted, you will receive technical help from the core ink! team and developers
                from supporting chains including Aleph Zero, Astar, and Phala, and 727 Ventures.
              </p>
